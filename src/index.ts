...
export { GmailDBError, AuthError, NotFoundError, ValidationError, RateLimitError, FileSizeError, NetworkError, TokenExpiredError, StorageFullError, InvalidCollectionError, CacheError } from './core/errors.js';